...
function updateGridFormation(formation) {
  ...
  if (formation === '4-4-2') {
    ...
    <svg aria-hidden="true" style="animation-duration: 3s;" class="inline w-8 h-8 text-purple-400 animate-spin dark:text-purple-400 fill-yellow-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
